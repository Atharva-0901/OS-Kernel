...
void kernel_main(uint32_t magic, uint32_t addr) {
    ...
    terminal_setcolor(make_color(LIGHT_GREEN, BLACK));
    terminal_writestring("Kernel is running successfully!\n");
    terminal_setcolor(make_color(LIGHT_GREY, BLACK));
    terminal_writestring("System halted. Press Ctrl+Alt+Del to restart.\n");
